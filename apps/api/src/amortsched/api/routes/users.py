...
@inject
async def get_me(request: Request, handler: GetUserHandler) -> Response:
...
@inject
async def get_profile(request: Request, handler: GetProfileHandler) -> Response:
    user_id = get_current_user_id(request)
...
@inject
async def upsert_profile(request: Request, handler: UpsertProfileHandler) -> Response:
    user_id = get_current_user_id(request)
